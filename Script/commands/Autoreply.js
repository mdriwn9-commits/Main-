...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "breakup": "চিন্তা করিস না… ইশিকা বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি ইশিকা বসের এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি ইশিকা কে বল জানু 😻🔥"
  };
